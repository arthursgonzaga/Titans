 ...
 *
 * Data: 22/08/2017
 * Modificado em: 08/09/2017 por Daniel Carvalho.
 *
...
#define R TA1CCR1    // PWM do canal 1 (somente operações internas)
#define L TA1CCR2    // PWM do canal 2

// Variáveis globais
//unsigned int T0 = 0;
unsigned int Pulse_1 = 0, Pulse_2 = 0; // Variáveis de aquisição de dados
